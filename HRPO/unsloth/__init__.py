...
# Define DEVICE_TYPE before models import to avoid circular import issues
# unsloth_zoo.vllm_utils may try to import this during model initialization
DEVICE_TYPE = "cuda"  # Unsloth only supports CUDA devices
